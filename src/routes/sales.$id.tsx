...
export const Route = createFileRoute("/sales/$id")({ component: InvoiceDetailPage });
  ...
  if (!inv) {
    return (
      <div className="flex flex-col h-full items-center justify-center gap-3 text-gray-400">
        ...
        <button onClick={() => navigate({ to: "/sales" })} className="text-sm text-primary hover:underline">← Back to Sales</button>
      </div>
    );
  }
    ...
    <div className="flex flex-col h-full bg-gray-100">
      ...
      <div className="flex-1 overflow-auto py-6 px-4 flex justify-center bg-gray-100">
        <div id="print-invoice"
          className="bg-white w-full max-w-[794px] shadow-lg print:shadow-none print:m-0 print:p-8"
          ...
          <div className="flex items-start justify-between mb-8 pb-5 border-b-2 border-primary">
            ...
            <div className="text-right">
              <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-2">Tax Invoice</p>
              ...
              {isPaid
                ...
                : <div className="mt-3 inline-block text-[11px] font-bold text-rose-600 bg-rose-50 border border-rose-200 px-2.5 py-1 rounded-full">BALANCE DUE</div>}
            </div>
          </div>

          {/* Bill To */}
          <div className="mb-7 bg-gray-50 rounded-lg p-4 border border-gray-100">
            <p className="text-[10px] font-bold uppercase tracking-[0.12em] text-gray-400 mb-1.5">Bill To</p>
          ...
          <div className="flex justify-end mb-7">
            <div className="w-[280px]">
              ...
              <div className="mt-2 pt-2 border-t border-gray-200 space-y-1">
                ...
                {balance > 0.01 && <TRow label="Balance Due" value={fmtMoney(balance)} cls="text-rose-600 font-bold text-[13px]" />}
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 pt-4 border-t border-dashed border-gray-200 text-center">
            <p className="text-[10px] text-gray-300 tracking-wide">Computer-generated invoice — no signature required · {co?.name}</p>
          </div>
        </div>
      </div>
    </div>
