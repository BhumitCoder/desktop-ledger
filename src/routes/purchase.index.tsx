    ...
    <div className="flex flex-col h-full bg-[#f5f6fa]">
      ...
      <div className="bg-white border-b px-5 py-3 flex items-center justify-between gap-3">
        ...
        >
          ...
          <kbd className="ml-1 text-[10px] bg-blue-500 px-1.5 py-0.5 rounded">Ctrl+P</kbd>
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-0 bg-white border-b">
        ...
        <SummaryCard label="Total Payable" value={totalPayable} color="text-rose-600" border />
