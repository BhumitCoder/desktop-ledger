  ...
  if (!ret) {
    return (
      <div className="flex flex-col h-full items-center justify-center gap-3 text-gray-400">
        ...
        <button onClick={() => navigate({ to: "/sale-return" })} className="text-sm text-primary hover:underline">← Back to Sale Returns</button>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col h-full bg-gray-100">
      <div className="no-print bg-white border-b px-5 py-3 flex items-center justify-between gap-3">
        <button onClick={() => navigate({ to: "/sale-return" })}
      ...
      <div className="flex-1 overflow-auto py-6 px-4 flex justify-center bg-gray-100">
        <div className="bg-white w-full max-w-[794px] shadow-lg print:shadow-none print:m-0" style={{ minHeight: "1123px", padding: "40px" }}>
          <div className="flex justify-between items-start mb-8">
            ...
            <div className="text-right">
              <div className="inline-block bg-amber-50 border-2 border-amber-300 rounded-lg px-5 py-3">
                <p className="text-[11px] font-bold text-amber-600 uppercase tracking-wider mb-1">Credit Note</p>
          ...
          <div className="border-t-2 border-b border-gray-200 py-4 mb-6">
            <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-1">Return From (Customer)</p>
