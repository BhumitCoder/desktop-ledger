...
import { PurchaseReturnRepo } from "@/repositories";
      ...
      <div className="bg-white border-b px-5 py-3 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[12px] text-gray-400">{rows.length} debit notes · Total: {fmtMoney(totalDebit)}</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-auto">
        <table className="w-full text-[13px] border-collapse">
          <thead className="sticky top-0 bg-white border-b z-10">
            <tr>
              {["Debit Note #", "Date", "Original Bill #", "Supplier", "Items", "GST", "Total", "Action"].map((h, i) => (
