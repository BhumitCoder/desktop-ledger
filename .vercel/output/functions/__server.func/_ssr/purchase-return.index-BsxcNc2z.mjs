...
import { o as ItemRepo, u as PurchaseReturnRepo } from "./repositories-DM2yCNqC.mjs";
import { r as require_jsx_runtime } from "../_libs/radix-ui__react-context+react.mjs";
import { N as CornerUpLeft, g as Plus, k as FileText, s as Trash2 } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/purchase-return.index-BsxcNc2z.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function PurchaseReturnPage() {
	const navigate = useNavigate();
	const [rows, setRows] = (0, import_react.useState)([]);
	const refresh = () => setRows(PurchaseReturnRepo.all().sort((a, b) => b.date.localeCompare(a.date)));
	(0, import_react.useEffect)(refresh, []);
	const totalDebit = rows.reduce((s, r) => s + r.total, 0);
	const pg = usePagination(rows);
	const handleDelete = (e, r) => {
		e.stopPropagation();
		if (!confirm(`Delete return ${r.number}? Returned quantities will be added back to stock.`)) return;
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-4 w-4" }), " New Purchase Return"]
				})]
			}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: "No purchase returns yet"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs mt-1",
									children: "Click \"New Purchase Return\" to create a debit note"
								})
							]
						}) }) : pg.paged.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
							onClick: () => navigate({
								to: "/purchase-return/$id",
								params: { id: r.id }
							}),
...
//#endregion
export { PurchaseReturnPage as component };
